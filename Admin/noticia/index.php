      ...
      <div class="row">
        <div class="col s4">
          ...
          <form class="" action="proceso_guardar.php" method="post" enctype="multipart/form-data">
              <input type="text" required name="titulo" placeholder="Titutlo"><br><br>
              <input type="text" required name="descrip" placeholder="Descripción"><br><br>
              <textarea name="noticia" required placeholder="Noticia" rows="8" cols="80"></textarea>
          ...
          <tbody>
            <?php
             ...
             <tr>
              ...
              <td><h5><?php echo $row['titulo']; ?> </h5></td>
              <td><h5><?php echo $row['descrip']; ?> </h5></td>
              <th>
